...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4 border-0">
        <div class="card-header py-3 bg-white border-0 d-flex align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Gerenciar Categorias de Portfólio</h6>
            @if (!empty($langs))
                ...
                <div class="col-md-5">
                    <div class="card bg-light border-0 rounded-4">
                        <div class="card-body p-4">
                            <h5 class="card-title mb-4">Nova Categoria de Projeto</h5>
                            @include('includes.form-errors')
                            <form action="{{route('project-category.store')}}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Nome da Categoria</label>
                                    <input type="text" name="name" class="form-control" placeholder="Ex: Web Design" required>
