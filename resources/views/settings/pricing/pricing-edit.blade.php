                    ...
                    <form action="{{route('pricing-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-lg-4 text-center">
                                ...
                                <img loading="lazy" class="img-fluid rounded-4 shadow-sm border mb-3" style="max-height: 180px; object-fit: cover;" src="{{$setting->banner_img ? $setting->banner_img : asset('img/200x200.png')}}" alt="Banner">
                            </div>
                            <div class="col-lg-8">
