...
<head>
    ...
    <meta name="author" content="kdkhost">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#0">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="{{route('home')}}/public/images/media/1705726533logo.png" alt="favicon" style="height:40px;" />
                    
                </div>
                <div class="sidebar-brand-text mx-3">ETH</div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseElements" class="collapse"  data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                    	<a class="collapse-item" href="{{ route('slider.index') }}?language=@php echo $lang->code; @endphp">Sliders </a>
                    	<a class="collapse-item" href="{{ route('service.index') }}?language=@php echo $lang->code; @endphp">Serviços</a>
                    	<a class="collapse-item" href="{{ route('testimonial.index') }}?language=@php echo $lang->code; @endphp">Depoimentos</a>
                        <a class="collapse-item" href="{{ route('member.index') }}?language=@php echo $lang->code; @endphp">Nossa Equipe</a>
                        <a class="collapse-item" href="{{ route('client.index') }}?language=@php echo $lang->code; @endphp">Clientes</a>
                        <a class="collapse-item" href="{{ route('pricing.index') }}?language=@php echo $lang->code; @endphp">Valores</a>
                    </div>
                </div>
            </li>
            @endif
