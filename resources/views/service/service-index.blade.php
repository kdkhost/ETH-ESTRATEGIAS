                            ...
                            @if($services)
                                @foreach($services as $service)
                                    <tr class="border-bottom-0">
                                        <td class="px-3"><input class="checkboxes form-check-input" form="delete-services-form" type="checkbox" name="checkbox_array[]" value="{{$service->id}}"></td>
                                        <td>
                                            <img loading="lazy" width="60" class="rounded-3 shadow-sm border border-2 border-white" src="{{$service->photo ? asset('images/media/' . $service->photo->file) : asset('img/200x200.png')}}" alt="">
                                        </td>
                                        <td>
