...
<div class="container-fluid">
    ...
    <div class="card gourmet-card-light shadow-sm border-0">
        <div class="card-header py-3 bg-white border-0 d-flex align-items-center">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-tags me-2"></i>Gerenciar Categorias</h6>
            @if (!empty($langs))
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{route('category.store')}}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-lg shadow-sm" placeholder="Ex: Tecnologia" required>
