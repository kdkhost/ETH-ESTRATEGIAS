...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="{{route('post.index') . '?language=' . request()->input('language')}}" class="btn btn-light shadow-sm btn-sm">
                <i class="fas fa-arrow-left fa-sm me-1"></i> Voltar Blog
            </a>
        </div>
    </div>
    ...
    <div class="card shadow mb-4 border-0">
        <div class="card-header py-3 bg-white border-0 d-flex align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Gerenciar Categorias</h6>
            @if (!empty($langs))
        ...
        <div class="card-body">
            <div class="row g-4">
                {{-- Listagem --}}
                <div class="col-md-7">
                    <form action="{{route('delete.category')}}" method="POST" id="delete-categories-form">
                        @csrf
                        @method('DELETE')
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle border-0" id="dataTable" width="100%" cellspacing="0">
                                <thead class="bg-light">
                                    <tr>
                                        <th class="border-0" width="40"><input type="checkbox" id="options" class="form-check-input"></th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="d-flex justify-content-end gap-1">
                                                        <a href="{{ route('category.edit', $category->id) . '?language=' . request()->input('language')}}" class="btn btn-sm btn-outline-primary border-0 shadow-none">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('category.destroy', $category->id) }}" method="POST" class="d-inline single-delete-form">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{route('category.store')}}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" placeholder="Ex: Tecnologia" required>
